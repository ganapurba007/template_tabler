...
<body>
  ...
  <div class="error-page-wrapper">
    <div class="error-card">
      <div class="error-title-code error-title-code-warning">403</div>
      <h1 class="h3 fw-bold heading-custom mb-2">Akses Ditolak (Forbidden)</h1>
      ...
      <div class="d-flex align-items-center justify-content-center gap-2">
        ...
        <button type="button" class="btn btn-outline-secondary" onclick="history.back()"><i class="ti ti-arrow-left me-1"></i> Sebelumnya</button>
      </div>
    </div>
  </div>
