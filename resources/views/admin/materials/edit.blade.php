                ...
                <form action="{{ route('admin.materials.update', $material) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row g-3 mb-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="url" class="form-control @error('video_url') is-invalid @enderror" id="video_url" name="video_url" value="{{ old('video_url', $material->video_url) }}" placeholder="https://www.youtube.com/watch?v=...">
                            @error('video_url')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <!-- Field: Document File -->
                        <div class="col-md-6">
                            <label for="document_file" class="form-label fw-semibold"><i class="ti ti-file-download me-1 text-warning"></i> File Dokumen Lampiran (Opsional)</label>
